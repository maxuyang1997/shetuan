...
<html>
	<head>
		...
		function saveapprove(obj){
		  var url="fundssaveapprove?id="+obj;
			...
			<div class="wrapper">
				<div id="operate_title">
				        <div class="operate_div">
	    					...
	    					<span onclick=""><font color="white" size="2" style="width: 150px;">审批页面</font></span>
					    </div>
				</div>
									...
									<table>
										<tr>
											<td>
												...
												&nbsp;&nbsp;&nbsp;
												<input type="text" id="fundscommunity" name="funds.funds_community" value="${request.fundsApprove.funds_community}" disabled>
												<input type="hidden" name="funds.funds_community" value="${request.fundsApprove.funds_community}">
											</td>
											<td>
												&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
											</td>
											<td>
												...
												&nbsp;&nbsp;&nbsp;
												<input type="text" name="funds.funds_people"  value="${request.fundsApprove.funds_people}" disabled />
												<input type="hidden" name="funds.funds_people" value="${request.fundsApprove.funds_people}">
											</td>
										...
										<tr>
											  ...
											  <td>
												...
												&nbsp;&nbsp;&nbsp;&nbsp;
												<input type="text" name="funds.funds_money"  value="${request.fundsApprove.surplus_money}" disabled/>
												<input type="hidden" name="funds.funds_money" value="${request.fundsApprove.surplus_money}">
											</td>
											<td>
												&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
											</td>
											<td>
												...
												&nbsp;&nbsp;&nbsp;&nbsp;
												<input type="text" name="funds.funds_date"  value="${request.fundsApprove.funds_date}" disabled/>
												<input type="hidden" name="funds.funds_date" value="${request.fundsApprove.funds_date}">
											</td>
										</tr>
										<tr>
											<td>
										...
										<tr>
											<td>
											    &nbsp;&nbsp;&nbsp;
												<input type="text" value="申请缘由           *"disabled="true" />
												&nbsp;&nbsp;&nbsp;
												<input type="text" name="funds.funds_reason"  value="${request.fundsApprove.funds_reason}" disabled />
												<input type="hidden" name="funds.funds_reason" value="${request.fundsApprove.funds_reason}">
											</td>
											<td>
												&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
											</td>
											<td>
											    &nbsp;&nbsp;&nbsp;
												<input type="text" value="审批人            *"disabled="true" />
												&nbsp;&nbsp;&nbsp;
												<input type="text" name="funds.examine_people"  value="<s:property value='#session.user.user_name' />" disabled />
												<input type="hidden" name="funds.examine_people" value="<s:property value='#session.user.user_name' />">
											</td>
										</tr>
										<tr>
											<td>
										...
										<tr>
											<td>
											    &nbsp;&nbsp;&nbsp;
												<input type="text" value="审批日期             *"disabled="true" />
												&nbsp;&nbsp;&nbsp;
												<input type="text" name="funds.examine_date"  value="${request.date2}" disabled />
												<input type="hidden" name="funds.examine_date" value="${request.date2}">
											</td>
											<td>
												&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
											</td>
											<td >
												&nbsp;&nbsp;&nbsp;
												<input type="text" value="审批状态                     *" disabled="true"  />
												&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
												<select name="funds.examine_program" style="width:160px">
										...
										<tr>
											<td colspan="3">
												...
												&nbsp;&nbsp;&nbsp;
												<input type="text" name="funds.note" value="${request.fundsApprove.note}" disabled/>
												<input type="hidden" name="funds.note" value="${request.fundsApprove.note}">
											</td>
                                        ...
                                        <tr>
											...
											&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
											&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
												<input type="button" name="" value="保存" onclick="saveapprove('${request.fundsApprove.funds_id}')" />
											</td>
											<td>
												&nbsp;
											</td>
											<td>
											&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
												<input type="button" name="" value="取消" onclick= "javascript:window.close();"/>
											</td>
										</tr>
									</table>
								</td>
