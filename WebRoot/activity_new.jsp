			...
			<div class="wrapper">
				<div id="operate_title">
					<div class="operate_div">
						...
						<span onclick="addactivity();"><font color="black">保存</font> </span>
					</div>
					<div class="operate_div">
						<img src="image/0023.PNG"
							style="margin:1px 5px 0px 5px; float: left;" />
						<span onclick="goactivity();"><font color="black">关闭</font></span>
					</div>
								...
								<td>
									<table>
										<tr>
											<td>
												&nbsp;&nbsp;&nbsp;
												<input type="text" value="活动名称             *" disabled="true" />
												&nbsp;&nbsp;&nbsp;
												<input type="text" name="activity.activity_name"  />
											</td>
											<td>
												&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
											</td>
											<td>
												...
												&nbsp;&nbsp;&nbsp;
													<select name="activity.activity_community" style="width:160px">
										...
										<tr>
											<td>
												...
												&nbsp;&nbsp;&nbsp;&nbsp;
												<input type="text" name="activity.activity_theme" />
											</td>
											<td>
												&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
											</td>
											<td>
												...
												&nbsp;&nbsp;&nbsp;&nbsp;
												<input class="Wdate" type="text" onClick="WdatePicker()" name="activity.activitydate"/>
											</td>
										</tr>
										<tr>
											<td>
                                           ...
                                           <td>
												...
												&nbsp;&nbsp;&nbsp;
												<input type="text" name="activity.unit" />
											</td>
											...
											<td>
												...
												&nbsp;&nbsp;&nbsp;
												<input type="text" name="activity.activity_content" />
											</td>
										</tr>
										<tr>
											<td>
										...
										<tr id="tr1">
											<td>
												...
												&nbsp;&nbsp;&nbsp;
												<input type="text" name="activity.hkcss_inspection" />
											...
											<td>
											  &nbsp;&nbsp;&nbsp;
												...
												&nbsp;&nbsp;&nbsp;
												<input type="text" name="activity.principal" />
											</td>
										</tr>
