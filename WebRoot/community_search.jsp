...
<div id="operate_content_table">
		  ...
		  <fieldset >
			...
			<form action="communitysearchcommunity" method="post">
				社团名称：<input type="text" name="community.community_name" >
				社团编号：<input type="text" name="community.community_code" >
				负责人：<input type="text" name="community.principal" >
				创始人：<input type="text" name="community.founder" >
			     &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
