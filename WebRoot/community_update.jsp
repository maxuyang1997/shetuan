...
<html>
	<head>
		...
		function savecommunity(){
		  var url="communityalertcommunity";
									...
									<table>
										<tr>
											...
											<td>
												...
												&nbsp;&nbsp;&nbsp;
												<input type="text" name="community.community_name"  value="${request.updatecommunity.community_name}" />
											</td>
										</tr>
										<tr>
											<td>
										...
										<tr>
											...
											<td>
												...
												&nbsp;&nbsp;&nbsp;&nbsp;
												<input type="text" name="community.principal"  value="${request.updatecommunity.principal}" />
											</td>
										</tr>
										<tr>
											<td>
										...
										<tr id="tr1">
											<td>
												...
												&nbsp;&nbsp;&nbsp;
												<input type="text" name="community.unit"  value="${request.updatecommunity.unit}" />
										...
										<tr>
                                           <td>
												...
												&nbsp;&nbsp;&nbsp;
												<input type="text" name="community.community_money"  value="${request.updatecommunity.community_money}" />
											</td>
											...
											<td>
												...
												&nbsp;&nbsp;&nbsp;
												<input type="text" name="community.intro"  value="${request.updatecommunity.intro}" />
											</td>
										</tr>
										<tr>
											<td>
										...
										<tr>
											<td colspan="3">
												...
												<textarea rows="1" cols="68" id="textareaid"
													name="community.note"> ${request.updatecommunity.note}</textarea>
											</td>
										</tr>
										<tr>
											<td>
