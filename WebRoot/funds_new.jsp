			...
			<div class="wrapper">
				<div id="operate_title">
					<div class="operate_div">
						...
						<span onclick="addfunds();"><font color="black">保存</font> </span>
					</div>
					<div class="operate_div">
						<img src="image/0023.PNG"
							style="margin:1px 5px 0px 5px; float: left;" />
						<span onclick="gofunds();"><font color="black">关闭</font></span>
					</div>
									...
									<table>
										<tr>
											<td>
												...
												&nbsp;&nbsp;&nbsp;
												<select name="funds.funds_community" style="width:160px">
											...
											<td>
												...
												&nbsp;&nbsp;&nbsp;
												<input type="text" name="funds.surplus_money" />
											</td>
										</tr>
										<tr>
											<td>
										...
										<tr>
											<td>
												...
												&nbsp;&nbsp;&nbsp;&nbsp;
												<input type="text" name="funds.funds_money" />
											</td>
											<td>
												&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
											</td>
											<td>
												...
												&nbsp;&nbsp;&nbsp;&nbsp;
												<input class="Wdate" type="text" onClick="WdatePicker()" name="funds.funds_date"/>
											</td>
										</tr>
										<tr>
											<td>
                                           ...
                                           <td>
												...
												&nbsp;&nbsp;&nbsp;
												<input type="text" name="funds.funds_reason" />
											</td>
											...
											<td>
												...
												&nbsp;&nbsp;&nbsp;
												<input type="text" name="funds.funds_people" />
											</td>
										</tr>
										<tr>
											<td>
