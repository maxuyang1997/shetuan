			...
			<div class="wrapper">
				<div id="operate_title">
				        <div class="operate_div">
	    					...
	    					<span onclick=""><font color="white" size="2" style="width: 150px;">修改活动信息</font></span>
					    </div>
				</div>
								...
								<td>
									<table>
										<tr>
											<td>
												&nbsp;&nbsp;&nbsp;
												<input type="text" value="活动名称             *" disabled="disabled" />
												&nbsp;&nbsp;&nbsp;
												<input type="text" name="activity.activity_name"  value="${request.updateactivity.activity_name}"/>
												<input type="hidden" name="activity.activity_id"  value="${request.updateactivity.activity_id}"   />
											</td>
											<td>
												&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
											</td>
											<td>
												&nbsp;&nbsp;&nbsp;
												<input type="text" value="所属团队             *" disabled="true" />
												&nbsp;&nbsp;&nbsp;
												<input type="text" name="activity.activity_community"  value="${request.updateactivity.activity_community}" disabled/>
											</td>
										</tr>
										<tr>
											<td>
										...
										<tr>
											<td>
												&nbsp;&nbsp;&nbsp;
												<input type="text" value="活动主题             *" disabled="true" />
												&nbsp;&nbsp;&nbsp;&nbsp;
												<input type="text" name="activity.activity_theme" value="${request.updateactivity.activity_theme}"/>
											</td>
											<td>
												&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
											</td>
											<td>
												&nbsp;&nbsp;&nbsp;
												<input type="text" value="举办日期        *"disabled="true"/>
												&nbsp;&nbsp;&nbsp;&nbsp;
												<input type="text" name="activity.activitydate" value="${request.updateactivity.activitydate}" disabled/>
											</td>
										</tr>
										<tr>
											<td>
                                           ...
                                           <td>
											    &nbsp;&nbsp;&nbsp;
												<input type="text" value="承办单位            *"disabled="true" />
												&nbsp;&nbsp;&nbsp;
												<input type="text" name="activity.unit" value="${request.updateactivity.unit}" />
											</td>
											...
											<td>
											    &nbsp;&nbsp;&nbsp;
												<input type="text" value="活动内容               *"disabled="true" />
												&nbsp;&nbsp;&nbsp;
												<input type="text" name="activity.activity_content" value="${request.updateactivity.activity_content}"/>
											</td>
										</tr>
										<tr>
											<td>
										...
										<tr id="tr1">
											<td>
												&nbsp;&nbsp;&nbsp;
												<input type="text" value="监查人              *"disabled="true" />
												&nbsp;&nbsp;&nbsp;
												<input type="text" name="activity.hkcss_inspection"  value="${request.updateactivity.hkcss_inspection}"/>
											...
											<td>
											  &nbsp;&nbsp;&nbsp;
												...
												&nbsp;&nbsp;&nbsp;
												<input type="text" name="activity.principal" value="${request.updateactivity.principal}"/>
											</td>
										</tr>
										...
										<tr>
											<td colspan="3">
												...
												<textarea rows="1" cols="68" id="textareaid"
													name="activity.note">${request.updateactivity.note}</textarea>
											</td>
										</tr>
										<tr>
											<td>
										 ...
										 <tr>
											...
											&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
											&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
												<input type="button" name="" value="保存" onclick="saveactivity()" />
											</td>
											<td>
												&nbsp;
											</td>
											<td>
											&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
												<input type="reset" name="" value="取消" onclick="goactivity()"/>
											</td>
										</tr>
