...
<div id="operate_content_table">
		  ...
		  <fieldset >
			...
			<form action="activitysearchactivity" method="post">
				活动主题：<input type="text" name="activity.activity_theme" >
				所属社团：<input type="text" name="activity.activity_community" >
				负责人：<input type="text" name="activity.principal" >
				活动内容：<input type="text" name="activity.activity_content" >
			     &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
