...
<div id="operate_content_table">
		  ...
		  <fieldset >
			...
			<form action="membersearchmember" method="post">
				输入姓名：<input type="text" name="member.member_name" >
				输入社团：<input type="text" name="member.member_community" >
				输入班级：<input type="text" name="member.classes" >
				输入寝室：<input type="text" name="member.dormitory" >
			     &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
