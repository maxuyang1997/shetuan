			...
			<div class="wrapper">
				<div id="operate_title">
					<div class="operate_div">
						...
						<span onclick="addmember();"><font color="black">提交</font> </span>
					</div>
					<div class="operate_div">
						<img src="image/0023.PNG"
							style="margin:1px 5px 0px 5px; float: left;" />
						<span onclick="gomember();"><font color="black">关闭</font></span>
					</div>
									...
									<table>
										<tr>
											<td>
												...
												&nbsp;&nbsp;&nbsp;
												<input type="text" name="member.member_code"  value='<s:property value="member_code"/>'   disabled/>
												<input type="hidden" name="member_code" value='<s:property value="member_code"/>'/>
											</td>
											<td>
												&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
											</td>
											<td>
												...
												&nbsp;&nbsp;&nbsp;
												<input type="text" name="member.member_name" disabled value='<s:property value="#session.user.user_name" />'/>
											</td>
										</tr>
										<tr>
											<td>
										...
										<tr>
											<td>
												...
												&nbsp;&nbsp;&nbsp;&nbsp;
												<select name="member.member_community" style="width:160px">
													   <s:iterator value="communitys" var="community">
								                         <option value='<s:property value="#community.community_name"/>'>
									                      <s:property value="#community.community_name" />
								                         </option>
							                           </s:iterator>
												</select>
											</td>
											...
											<td>
												&nbsp;&nbsp;&nbsp;
												<input type="text" value="所在社团职务         *"disabled="true"/ >
												&nbsp;&nbsp;&nbsp;&nbsp;
												<select name="member.member_duty" style="width:160px">
													<s:iterator value="dutys" var="duty">
								                         <option value='<s:property value="#duty.duty_name"/>'>
									                      <s:property value="#duty.duty_name" />
								                         </option>
							                          </s:iterator>
												</select>
											</td>
										...
										<tr id="tr1">
											<td>
												...
												&nbsp;&nbsp;&nbsp;
												<select name="member.gender" style="width:160px">
								                         <option value="男">
									                                               男
								                         </option>
								                         <option value="女">
											...
											<td>
											  &nbsp;&nbsp;&nbsp;
												<input type="text" value="会员电话               *"disabled="true" />
												&nbsp;&nbsp;&nbsp;
										...
										<tr>
											...
											<td>
											    &nbsp;&nbsp;&nbsp;
												<input type="text" value="会员寝室               *"disabled="true" />
												&nbsp;&nbsp;&nbsp;
												<input type="text" name="member.dormitory" />
											</td>
											...
											<td>
											    &nbsp;&nbsp;&nbsp;
												<input type="text" value="入会时间               *"disabled="true" />
												&nbsp;&nbsp;&nbsp;
												<input class="Wdate" type="text" onClick="WdatePicker()" name="member.joindate"/>
											</td>
										</tr>
										<tr>
											<td>
										...
										<tr>
										    <td>
												...
												&nbsp;&nbsp;&nbsp;
												<input type="text" name="member.classes" />
											</td>
											<td id="td5">
												&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
											</td>
											<td>
											  &nbsp;&nbsp;&nbsp;
												...
												&nbsp;&nbsp;&nbsp;
												<input type="text" name="member.department" />
											</td>
