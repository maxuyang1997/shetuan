...
<html>
	<head>
		...
		function savecommunity(){
		  var url="communityapprovecommunity";
			...
			<div class="wrapper">
				<div id="operate_title">
				        <div class="operate_div">
	    					...
	    					<span onclick=""><font color="black" size="2" style="width: 150px;">审核信息</font></span>
					    </div>
				</div>
									...
									<table>
										<tr>
											<td>
												...
												&nbsp;&nbsp;&nbsp;
												<input type="text" name="community.community_code"  value="${request.updatecommunity.community_code}"   disabled="disabled" />
												<input type="hidden" name="community.community_id"  value="${request.updatecommunity.community_id}"   />
												<input type="hidden" name="community.community_code"  value="${request.updatecommunity.community_code}"   />
												<input type="hidden" name="community.user_account"  value="${request.updatecommunity.user_account}"   />
											</td>
											<td>
												&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
											</td>
											<td>
												...
												&nbsp;&nbsp;&nbsp;
												<input type="text" name="community.community_name"  value="${request.updatecommunity.community_name}" disabled="disabled"  />
												<input type="hidden" name="community.community_name"  value="${request.updatecommunity.community_name}"   />
											</td>
										</tr>
										<tr>
											<td>
										...
										<tr>
											<td>
												...
												&nbsp;&nbsp;&nbsp;
												<input type="text" name="community.founder"  value="${request.updatecommunity.founder}" disabled="disabled" />
												<input type="hidden" name="community.founder"  value="${request.updatecommunity.founder}"   />
											</td>
											<td>
												&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
											</td>
											<td>
												...
												&nbsp;&nbsp;&nbsp;
												<input type="text" name="community.principal"  value="${request.updatecommunity.principal}" disabled="disabled" />
												<input type="hidden" name="community.principal"  value="${request.updatecommunity.principal}"   />
											</td>
										</tr>
										<tr>
											<td>
										...
										<tr id="tr1">
											<td>
												...
												&nbsp;&nbsp;&nbsp;
												<input type="text" name="community.unit"  value="${request.updatecommunity.unit}" disabled="disabled"  />
												<input type="hidden" name="community.unit"  value="${request.updatecommunity.unit}"   />
											...
											<td>
											  &nbsp;&nbsp;&nbsp;
												...
												&nbsp;&nbsp;&nbsp;
												<input type="text"  name="community.founddate"  value="${request.updatecommunity.founddate}" disabled="disabled" />
												<input type="hidden" name="community.founddate"  value="${request.updatecommunity.founddate}"   />
											</td>
										</tr>
										...
										<tr>
                                           <td>
											    &nbsp;&nbsp;&nbsp;
												<input type="text" value="设团经费               *"disabled="true" />
												&nbsp;&nbsp;&nbsp;
												<input type="text" name="community.community_money"  value="${request.updatecommunity.community_money}" disabled="disabled" />
												<input type="hidden" name="community.community_money"  value="${request.updatecommunity.community_money}"   />
											</td>
											...
											<td>
												...
												&nbsp;&nbsp;&nbsp;
												<input type="text" name="community.intro"  value="${request.updatecommunity.intro}" disabled="disabled" />
												<input type="hidden" name="community.intro"  value="${request.updatecommunity.intro}"   />
											</td>
										</tr>
										<tr>
											<td>
										...
										<tr>
											<td>
												&nbsp;&nbsp;&nbsp;
												<input type="text" value="备注                      *" disabled="true" >
												&nbsp;&nbsp;&nbsp;
													<input type="text" name="community.note"  value="${request.updatecommunity.note}" disabled="disabled" />
													<input type="hidden" name="community.note"  value="${request.updatecommunity.note}"   />
											</td>
											<td>
												&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
											</td>
											<td>
											    &nbsp;&nbsp;&nbsp;
												<input type="text" value="审核结果               *"disabled="true" />
												&nbsp;&nbsp;&nbsp;
												<select name="community.state" >
	                                    ...
	                                    <tr>
											...
											&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
											&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
												<input type="button" name="" value="保存" onclick="savecommunity()" />
											</td>
											<td>
												&nbsp;
											</td>
											<td>
											&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
												<input type="reset" name="" value="取消" onclick="gocommunity()"/>
											</td>
										</tr>
									</table>
								</td>
