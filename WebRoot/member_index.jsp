	...
	<script type="text/javascript">
	   ...
	   function updatemember(){
			...
			var inputs = document.getElementsByTagName("input");
		    	...
		    	for(var i = 0 ;i<inputs.length;i++){
					if(inputs[i].type=="checkbox" ){
						if(inputs[i].checked){
							memberIds += "," + inputs[i].id;
						}
					}
				}
		    	 var pos=memberIds.lastIndexOf(",");
                 var postfix = memberIds.substring(pos+1,memberIds.length);
                 
                 if(postfix==""){
                	 alert("请选择一条!");
                	 return false;
                 }else{
                	 location.href="memberupdatemember?id="+postfix;
                 }
	   ...
	   function deletemember(){
			...
			var inputs = document.getElementsByTagName("input");
				...
				location.href="memberdeleteMember?memberIds="+memberIds;
       ...
       <div id="pagetitle">
		...
		<div id="page">
			...
			<div class="wrapper">
				...
				<s:if test='#session.user.duty.duty_ID!=5&&#session.user.duty.duty_ID!=2'>
					<div class="operate_div">
						<img src="image/0002.PNG"
							style="margin:1px 5px 0px 4px; float: left;" />
						 <span onclick="updatemember();"><font color="black">修改信息</font></span>
					</div>
					<s:if test='#session.user.duty.duty_ID!=4'>
					<div class="operate_div">
						<img src="image/0003.PNG"
							style="margin:1px 5px 0px 4px; float: left;" />
						  <span onclick="deletemember();"><font color="black">删除信息</font></span>
					</div>
					</s:if>
					</s:if>
					<div class="operate_div">
					    ...
					    <span onclick="searchmember();"><font color="black">查询信息</font></span>
					</div>
					...
					<table border="1" align="center" width="100%" class="datalist" id="tableid">
						<tr>
							...
							<th>
								<font color="black" size="2">姓名</font>
							</th>
							<th>
								<font color="black" size="2">性别</font>
							</th>
							<th>
								<font color="black" size="2">电话</font>
							</th>
							<th>
								<font color="black" size="2">职务</font>
							</th>
							<th>
								<font color="black" size="2">社团</font>
							</th>
						    <th>
								<font color="black" size="2">班级</font>
							</th>
							<th>
								<font color="black" size="2">院系</font>
							</th>
							<th>
								<font color="black" size="2">寝室</font>
							</th>
							<th>
								<font color="black" size="2">加入时间</font>
							 </th>
							<th>
						...
						<s:iterator value="memberList" var="members">
						<tr>
						    <td>
							     <input type="checkbox" id="<s:property value="#members.member_id" />" name="checkboxname">
							</td>
							<td>
								<font color="black"><s:property value="#members.member_name" /></font>
							</td>
							<td>
							    <s:property value="#members.gender" />
							</td>
							<td>
								<s:property value="#members.tel" />
							</td>
							<td>
								<s:property value="#members.member_duty" />
							</td>
							<td>
								<s:property value="#members.member_community" />
							</td>
							<td>
								<s:property value="#members.classes" />
							</td>
							<td>
							    <s:property value="#members.department" />
							</td>
							<td>
								<s:property value="#members.dormitory" />
							</td>
							<td>
								<s:date name="#members.joindate" format="yyyy-MM-dd"/>
							</td>
							<td>
								<s:property value="#members.note" />
							</td>
